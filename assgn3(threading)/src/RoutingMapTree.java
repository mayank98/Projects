...
public class RoutingMapTree
{
    ...
    public void performAction(String actionMessage)
    {
        ...
        System.out.print("at time "+tStart+" ");
        String str=in.next();
        int a,b,tEnd;
        //assignment 2 start
        ...
        if(str.equals("queryNthChild"))
        {
            ...
            {
                System.out.println("invalid index of the child.");
            }
            /*
        ...
        if(str.equals("switchOnMobile"))
        {
            ...
            b=in.nextInt();
            tEnd=-2;
            MobilePhone m=new MobilePhone(this,a,b,str,tStart,tEnd);
            Thread t=new Thread(m);
            String name="MobilePhone "+t.getName();
            t.setName(name);
            t.start();
            try{t.join();}
            catch (Exception e){}
